...
export const Swap = () => {
  ...
  const [isExpandSlippage, setIsExpandSlippage] = React.useState(false)
  ...
  return (
    <CardMain>
      <div className={classNames('flex flex-col')}>
        <div>
          ...
          <Input
            ...
            endContent={<> {!isSwap ? <B4FWXChip /> : <USDCChip />} </>}
          />
        </div>
      ...
      <div className={'mt-4 rounded-[12px] border border-divider'}>
        ...
        {isExpand && (
          <div className={'space-y-2 px-3 pb-3'}>
            <div className={'flex items-center justify-between'}>
              <p className={'w-full text-xs text-gray-300'}>Max. Slippage</p>
              {!isExpandSlippage ? (
                <Chip
                  onClick={() => {
                ...
                <div className={'flex items-center space-x-1 rounded-[8px] bg-secondary p-1'}>
                  <Chip
                    className={'cursor-pointer bg-divider'}
                    size={'sm'}
                    radius={'sm'}
                    color={'secondary'}
                  >
      ...
      <RequireConnected>
        ...
        <ActionButton isDisabled={true}>Insufficient liquidity for this Trade</ActionButton>
